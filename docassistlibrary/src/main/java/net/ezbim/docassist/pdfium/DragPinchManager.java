...
import net.ezbim.docassist.pdfium.util.DragPinchListener;

import static net.ezbim.docassist.pdfium.util.Constants.Pinch.MAXIMUM_ZOOM;
import static net.ezbim.docassist.pdfium.util.Constants.Pinch.MINIMUM_ZOOM;
import static net.ezbim.docassist.pdfium.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_DISTANCE;
import static net.ezbim.docassist.pdfium.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_TIME;
